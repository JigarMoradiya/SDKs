...
//                if (apiName.equalsIgnoreCase(com.example.mentalhealthpatient.utils.Constants.GET_S3_DOWNLOAD_URL)) {
//                    signed_url = successResponse.get(com.example.mentalhealthpatient.utils.Constants.DATA).getAsJsonObject().get("s3signedGetUrl").getAsString();
//                }
...
//
//        mainApiCall.getData(params,com.example.mentalhealthpatient.utils.Constants.GET_S3_DOWNLOAD_URL, mainApiResponseInterface);
//    }
}
