...
import com.jigar.me.databinding.RawLayoutSudokuPlay4by4Binding
...
class Play4By4Adapter(
...
) : RecyclerView.Adapter<Play4By4Adapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): MyViewHolder {
        val view: View = LayoutInflater.from(viewGroup.context).inflate(
            R.layout.raw_layout_sudoku_play_4by4,
            viewGroup, false
        )
    ...
    inner class MyViewHolder(viewLayout: View?) :
        ...
        val binding: RawLayoutSudokuPlay4by4Binding = DataBindingUtil.bind(itemView)!!
