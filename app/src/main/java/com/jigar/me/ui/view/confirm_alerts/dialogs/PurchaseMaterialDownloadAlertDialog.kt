...
object PurchaseMaterialDownloadAlertDialog {
    ...
    fun showPopup(activity: Activity, listener: PurchaseMaterialAlertDialogInterface) {
        ...
        alertLayout.txtQue.text = activity.resources.getString(R.string.txt_page_practise_material)
    ...
    interface PurchaseMaterialAlertDialogInterface {
        fun onPurchaseClick()
    }
