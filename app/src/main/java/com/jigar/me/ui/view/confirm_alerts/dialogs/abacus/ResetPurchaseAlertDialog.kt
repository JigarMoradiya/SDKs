...
object ResetPurchaseAlertDialog {
    ...
    fun showPopup(activity: Activity,listener: ResetPurchaseAlertDialogInterface) {
        ...
        alertLayout.txtQue.text = activity.resources.getString(R.string.txt_page_reset_not)
    ...
    interface ResetPurchaseAlertDialogInterface {
        fun goToPurchase()
    }
